"""The served swing prediction policy: an immutable, content-addressed identity.

Serving binds :class:`SwingPredictionPolicy` into each prediction, and outcome
contracts and promotion evidence verify it with :func:`parse_swing_prediction_policy`.
Its hash changes if and only if its declarative semantics change. Executable fills,
costs and capital allocation belong to ``execution_policy``.
"""
