...
The B0, B1, B2, and D1 baselines have been run on this frozen input and rejected. B0 mean top-10 excess return is -0.09868% walk-forward and -0.09387% on deterministic ticker holdout. B1 improves AUC to 0.53258/0.53341, but top-10 excess return remains -0.07974%/-0.07763%. B2 reaches -0.06558% walk-forward but remains -0.07807% on ticker holdout. D1 downside AUC is only 0.51390/0.51231 with approximately 1.01x lift, so it cannot serve as a risk gate. All remain unpromoted research artifacts. Ranker ablations and candidate selection have not completed.
