...
- **R6 Repository / Delivery Hardening:** remove legacy promotion + obsolete runtime
  ...
  reports; CI (tests, Ruff, strict mypy, import-boundary, secret/dep/container scanning,
  deterministic-artifact tests). Replace secrets with workload identity/Key Vault refs.
