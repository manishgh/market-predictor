...
class CrossSectionalValidationTests(unittest.TestCase):
    ...
    def test_query_spanning_sessions_fails_closed(self) -> None:
        ...
        splitter = SessionPurgedWalkForwardSplit(n_splits=2, min_train_sessions=4, min_train_rows=10)
    ...
    def test_causal_fold_filters_unmatured_labels_and_persists_unique_row_ids(self) -> None:
        ...
        poisoned = frame.copy()
        poisoned.loc[fold.test_indices, "label_available_at_utc"] = pd.Timestamp(datetime(2030, 1, 1, tzinfo=UTC))
