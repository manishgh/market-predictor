...
from market_predictor.research.intraday_cross_sectional.failure_diagnostics import FailureAttributionConfig, build_failure_attribution


class CrossSectionalFailureAttributionTests(unittest.TestCase):
