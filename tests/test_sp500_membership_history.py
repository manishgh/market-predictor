...
import market_predictor.universe.sp500.membership_history as universe_module
...
class Sp500PointInTimeUniverseTests(unittest.TestCase):
    def test_universe_module_has_no_hidden_network_collection_api(self) -> None:
        ...
        self.assertFalse(hasattr(universe_module, "discover_sp500_change_announcements"))
    ...
    def test_invalid_midcap_500_heading_requires_prose_corroboration(self) -> None:
        ...
        with self.assertRaisesRegex(DataReadinessError, "no structured S&P 500"):
            parse_sp500_changes(
                ...
                published_date=date(2018, 6, 4),
                source_sha256=("46964cc0739c5d8fd2067bc9c27adfb1e4863c2c9e73e7b2804fc71ae6db2fe3"),
            )
        ...
        pre_header_poisoned = corroborated.replace(
            ...
            ("<tr><td>ADDED</td><td>Poison Corp.</td><td>Utilities</td></tr><tr><td></td><td>COMPANY</td>"),
        )
        with self.assertRaisesRegex(DataReadinessError, "no structured S&P 500"):
            parse_sp500_changes(
                pre_header_poisoned,
    ...
    def test_public_reconstruction_verifies_event_directories(self) -> None:
        ...
        with patch(
            "market_predictor.universe.sp500.index_change_events.require_spglobal_event_reconstruction_ready",
        ...
        verifier.assert_called_once_with(Path("events"), archive_directory=Path("raw"))
