...
def write_test_shadow_bundle(
    ...
    *,
    ...
    evidence["session_date_et"] = pd.to_datetime(evidence["session_date_et"]).dt.date
    evidence["paired_improvement"] = evidence["candidate_benchmark_excess_return"] - evidence["baseline_benchmark_excess_return"]
    ...
    content: dict[str, Any] = {
        ...
        "baseline_artifact_sha256": hypothesis["baseline_artifact_sha256"],
        "candidate_artifact_sha256": candidate_artifact_sha256,
        "prediction_policy_sha256": hypothesis["prediction_policy_sha256"],
        "execution_policy_sha256": hypothesis["execution_policy_sha256"],
