...
from market_predictor.research.intraday_cross_sectional.data_audit import audit_bars, build_data_audit


class CrossSectionalDataAuditTests(unittest.TestCase):
    ...
    def test_gap_and_partial_feed_fail_strict_audit(self) -> None:
        ...
        with self.assertRaises(DataReadinessError):
            from market_predictor.research.intraday_cross_sectional.data_audit import DataAuditReport
