...
REMOVED_PRODUCTION_MODULES = (
    ...
    "market_predictor.drift",
    "market_predictor.drift_policy",
    "market_predictor.prediction_policy",
    "market_predictor.outcome_contracts",
    "market_predictor.outcome_maturation",
    "market_predictor.outcome_repository",
    "market_predictor.outcome_worker",
    "market_predictor.performance_monitoring",
    "market_predictor.swing.contracts.prediction_policy",
    ...
    "market_predictor.intraday.audits",
    "market_predictor.intraday.contracts.dataset_schemas",
    "market_predictor.intraday.contracts.history_collection",
    "market_predictor.intraday.contracts.lineage",
    "market_predictor.intraday.dataset",
    "market_predictor.intraday.datasets",
    "market_predictor.intraday.evaluation",
    "market_predictor.intraday.features",
    "market_predictor.intraday.labels",
    "market_predictor.intraday.model",
    "market_predictor.intraday.promotion",
    "market_predictor.intraday.specialist_collection",
    "market_predictor.intraday.specialist_contracts",
    "market_predictor.intraday.specialist_coverage",
    "market_predictor.intraday.specialist_dataset",
    "market_predictor.intraday.specialist_experiments",
    "market_predictor.intraday.specialist_model",
    "market_predictor.intraday.specialist_training_data",
    "market_predictor.intraday.training",
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "import market_predictor.drift",
        "from market_predictor.drift import audit_feature_drift",
        "import market_predictor.drift_policy",
        "from market_predictor.drift_policy import DriftPolicyV2",
        "import market_predictor.prediction_policy",
        "from market_predictor.prediction_policy import PredictionSelectionPolicy",
        "import market_predictor.outcome_contracts",
        "from market_predictor.outcome_contracts import MaturedOutcomeV1",
        "import market_predictor.outcome_maturation",
        "from market_predictor.outcome_maturation import mature_prediction",
        "import market_predictor.outcome_repository",
        "from market_predictor.outcome_repository import OutcomeRepository",
        "import market_predictor.outcome_worker",
        "from market_predictor.outcome_worker import mature_pending_intents",
        "import market_predictor.performance_monitoring",
        "from market_predictor.performance_monitoring import build_performance_cohorts",
...
@pytest.mark.parametrize(
    "statement",
    (
        "import market_predictor.edge_rebuild.broad_intraday_history",
        "import market_predictor.edge_rebuild.broad_intraday_history as broad_history",
        "from market_predictor.edge_rebuild import broad_intraday_history",
        "from market_predictor.edge_rebuild.broad_intraday_history import build_broad_intraday_history_plan",
    ),
)
...
@pytest.mark.parametrize(
    "statement",
    (
        "import market_predictor.edge_rebuild.prospective_sip_session",
        "import market_predictor.edge_rebuild.prospective_sip_session as session",
        "from market_predictor.edge_rebuild import prospective_sip_session",
        "from market_predictor.edge_rebuild.prospective_sip_session import collect_prospective_sip_session",
    ),
)
...
@pytest.mark.parametrize(
    "statement",
    (
        "import market_predictor.edge_rebuild.prospective_analyst_revision_horizon",
        "import market_predictor.edge_rebuild.prospective_analyst_revision_horizon as horizon",
        "from market_predictor.edge_rebuild import prospective_analyst_revision_horizon",
        "from market_predictor.edge_rebuild.prospective_analyst_revision_horizon import publish_prospective_analyst_revision_horizon",
    ),
)
