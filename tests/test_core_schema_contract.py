...
from market_predictor.core.schema import CROSS_SECTIONAL_SCHEMA_VERSION, FrozenContract, SchemaIdentity
...
class CoreSchemaContractTests(unittest.TestCase):
    def test_schema_identity_is_normalized_strict_and_immutable(self) -> None:
        ...
        self.assertEqual(identity.version, CROSS_SECTIONAL_SCHEMA_VERSION)
